...
public class SortingTest {
	...
	List<Integer> input_data = get_random_data(20, 500);
	List<Integer> input_data_orig = new ArrayList<Integer>(input_data);
	int size_before = input_data.size();
	...
	List<Integer> input_data = get_random_data(10, 500);
	List<Integer> input_data_orig = new ArrayList<Integer>(input_data);
	int size_before = input_data.size();
	...
	System.out.println("Contains same elements: " + input_data.containsAll(input_data_orig));
	System.out.println("Contains right amount: " + input_data.containsAll(input_data_orig));
	...
	List<Integer> input_data = get_random_data(50, 500);
	List<Integer> input_data_orig = new ArrayList<Integer>(input_data);
	int size_before = input_data.size();
...
public void printdata(List<Integer> input_data){
	
	System.out.println("Contains right size: " + input_data.size());
	//System.out.println("Contains same elements: " + input_data.containsAll(input_data_orig));
	//System.out.println("Contains right amount: " + input_data.containsAll(input_data_orig));
